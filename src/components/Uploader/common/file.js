...
import { blobSlice } from "@/assets/js/utils"
...
utils.extend(File.prototype, {
    ...
    getMd5: function() {
        return new Promise(function(resolve, reject) {
            ...
            var opts = this.uploader.opts;
            var _file = this.file;
            var BLOB_SLICE = blobSlice,
                chunkSize = opts.chunkSize, // read in chunks of 2MB
                currentChunk = 0,
                ...
                frOnload = (function(e) {
                    ...
                    if (this.reckon_md5_num != reckon_md5_num) {
                        this.reckon_md5_num = reckon_md5_num;
                    }
            ...
            function loadNext() {
                ...
                fileReader.readAsArrayBuffer(BLOB_SLICE.call(_file, start, end));
            }
            loadNext();
        }.bind(this))
    }
