...
utils.extend(Chunk.prototype, {
  ...
  test: function () {
    ...
    if(this.file.uniqueIdentifier === '') {
      this.file.getMd5().then(function (md5) {
  ...
  status: function (isTest) {
    ...
    if (this.readState === 1) {
      ...
      var _status
      if (this.uploader.opts.successStatuses.indexOf(this.xhr.status) > -1 && !isTest) {
        // HTTP 200, perfect
